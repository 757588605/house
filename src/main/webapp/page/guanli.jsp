...
<DIV class=search>  欢迎:${sessionScope.loginInfo.name}<LABEL class="ui-green searchs" onclick="location.href='goFaBu'">发布房屋信息</LABEL>
  ...
  <TR>
    ...
    <TD>
      <DL>
        ...
        <DD>${h.dname}=${h.sname},${h.floorage}平米<BR>联系方式：${h.contact},${h.tname}

        </DD></DL></TD>
    <TD class=house-type><LABEL class=ui-green></LABEL> <c:choose>
